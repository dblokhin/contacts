...
class MnemonicGenerator {
  ...
  String _mnemonicFromEntropy(List<int> entropy) {
    ...
    // append checksum
    final digest = sha256.convert(entropy);
    ...
    while (bits > 0) {
      ...
      final v = value >> shift;
      final decrement = v << shift;
      final i = int.parse(v.toString());
      result.add(_wordlist[i]);
  ...
  int get entropyBits {
    switch (size) {
      ...
      case EntropySize.s160:
        return 160;
      case EntropySize.s192:
        return 192;
      case EntropySize.s224:
        return 224;
...
final List<String> _wordlist = '''abandon
ability
able
about
above
